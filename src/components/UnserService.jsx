          ...
          {UnserServiceData.map((data, index) => {
            return (
              <Row
                ...
                key={index}
              >
                <Col md={9} lg={data.col} className="px-lg-0">
                  <div className={data.maxWidth}>
                    <h6 className="ff_Oswald fw-medium fs_3xl lh_144 text-capitalize text-white pb-2 pb-lg-1">
                      {data.heading}
                    </h6>
                    <p className="ff_poppins fw-normal fs_sm text-white opacity_07 lh_170">
                      {data.para}
                    </p>
                  </div>
                </Col>
                <Col md={9} lg={5} className="mt-2 mt-lg-0 px-lg-0">
